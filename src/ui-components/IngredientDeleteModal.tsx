...
import { deleteIngredient } from '../utils/ingredientSlice';
import ingredientApiService from '../utils/ingredients-api.service';

function IngredientDeleteModal({ open, handleClose, ingredient }: { open: boolean, handleClose: () => void, ingredient: Ingredient }) {
                ...
                <Box sx={style}>
                    ...
                    <ContentContainer>
                        <MainContentContainer>
                            Do you want to delete ingredient - {ingredient.title} ?
                        </MainContentContainer>
                        <ButtonContainer>
